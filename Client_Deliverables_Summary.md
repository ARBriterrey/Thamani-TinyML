...
*   **Cloud Initialization Pipeline:** Establishing the UART communication logic between the STM32 and the ESP32-S3 bridge. This allows the STM32 to package the saved patient data and trigger the ESP32 to push the payloads over Wi-Fi directly to the Docker Orchestrator.
